...
public class ClipBoardUtil {
     ...
     * @return
     */
    private ClipBoardValue getSysClipBoard(DataFlavor dataFlavor, ClipBoardValue clipBoardValue)
    ...
    public String getSysClipBoardText() throws IOException, UnsupportedFlavorException {
    ...
    public List<File> getSysClipBoardFileList() throws IOException, UnsupportedFlavorException {
    ...
    public void setSysClipBoardFileList(final List<File> fileList) {
        Clipboard sysc = Toolkit.getDefaultToolkit().getSystemClipboard();
